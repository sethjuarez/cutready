...
<Screenshot src="/cutready/images/sketch-sidebar.png" darkSrc="/cutready/images/sketch-sidebar-dark.png" alt="CutReady interface with sidebar" caption="CutReady's interface showing sidebar navigation and explorer panel" />
