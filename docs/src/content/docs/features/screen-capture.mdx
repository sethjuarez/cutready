...
<Screenshot src="/cutready/images/sketch-editor-full.png" darkSrc="/cutready/images/sketch-editor-full-dark.png" alt="Sketch editor with screenshot column" caption="The planning table includes a screenshot column for capturing reference images at each step" />
