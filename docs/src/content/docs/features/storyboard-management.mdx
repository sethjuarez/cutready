...
<Screenshot src="/cutready/images/storyboard-view.png" darkSrc="/cutready/images/storyboard-view-dark.png" alt="Storyboard view" caption="Storyboard view showing an ordered sequence of sketches" />
