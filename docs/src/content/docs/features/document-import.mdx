...
<Screenshot src="/cutready/images/notes-editor-full.png" darkSrc="/cutready/images/notes-editor-full-dark.png" alt="Notes editor with imported content" caption="Imported documents appear as markdown notes that you can edit and reference" />
