...
For Microsoft Foundry with OAuth, authorization is checked at both the project
and model-inference layers. A signed-in user needs project access, such as
**Azure AI Foundry User**, and model invocation access, such as **Cognitive
Services OpenAI User** on the backing Azure AI Services/OpenAI resource.
