...
<Screenshot src="/cutready/images/sketch-with-chat.png" darkSrc="/cutready/images/sketch-with-chat-dark.png" alt="AI chat panel with function calling" caption="The AI assistant uses function calling to read and modify sketches in real-time" />
