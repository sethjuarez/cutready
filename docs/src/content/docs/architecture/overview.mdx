...
<Screenshot src="/cutready/images/app-overview.png" alt="CutReady application overview" caption="CutReady's main interface with sidebar, sketch editor, and chat panel" />
