...
- ✅ **AI assistant** — 3 built-in agents and custom agents
...
- ✅ **Azure OpenAI integration** — With OAuth support
...
- ✅ AI chat assistant with built-in and custom agents
- ✅ Sparkle buttons for one-click content generation and improvement
- ✅ Azure OpenAI integration with configurable API endpoints
