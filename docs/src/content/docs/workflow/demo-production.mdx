...
collaborating on demo videos. The current release (v0.5.0) focuses on the
...
**Key features:** [Sketch Editor](/cutready/features/sketch-editor/), [Notes & Markdown](/cutready/features/notes-markdown/), [Storyboard Management](/cutready/features/storyboard-management/), [AI-Assisted Workflow](/cutready/workflow/ai-workflow/), [Importing Materials](/cutready/workflow/import-workflow/)
...
**Key features:** [Version History](/cutready/collaboration/version-history/), [Merging](/cutready/collaboration/merging/), [History Graph](/cutready/collaboration/history-graph/), [Remote Sync](/cutready/collaboration/remote-sync/)
...
<Aside type="note" title="Coming Soon">
  ...
  [Browser Recording](/cutready/features/browser-recording/) page for details
  on what's planned.
</Aside>
