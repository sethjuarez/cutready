...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::draftline::open_workspace,
            commands::draftline::clone_workspace,
            commands::draftline::adopt_workspace,
            commands::draftline::inspect_workspace,
            commands::draftline::verify_workspace,
            ...
            commands::draftline::preflight_publish_history_cleanup,
            commands::draftline::publish_history_cleanup,
            commands::draftline::resolve_rewritten_version,
            commands::draftline::preflight_undo_history_cleanup,
            commands::draftline::undo_history_cleanup,
            commands::draftline::list_pending_history_cleanups,
            commands::draftline::publish_pending_history_cleanup,
            commands::draftline::undo_pending_history_cleanup,
            commands::draftline::abandon_pending_history_cleanup,
            commands::draftline::get_workspace_graph,
            commands::draftline::get_workspace_graph_refs,
            commands::draftline::get_workspace_graph_summary,
            commands::draftline::get_workspace_graph_overview,
            commands::draftline::get_workspace_graph_around_version,
            commands::draftline::get_workspace_graph_for_variation,
            commands::draftline::get_workspace_graph_agent_summary,
            commands::draftline::get_workspace_graph_neighborhood,
            commands::draftline::search_workspace_graph,
            commands::draftline::get_workspace_graph_path,
            commands::draftline::get_workspace_graph_common_ancestor,
            commands::draftline::get_workspace_graph_node,
            commands::draftline::get_workspace_graph_compare_summary,
            commands::draftline::diff_versions,
            commands::draftline::diff_version_to_workspace,
            commands::draftline::diff_workspace_file,
            commands::draftline::preview_version,
            commands::draftline::preview_version_file,
            commands::draftline::preview_workspace_file,
            commands::draftline::restore_version_as_new_save,
            commands::draftline::restore_version_as_new_save_to_variation,
            commands::draftline::save,
            commands::draftline::list_shelves,
            commands::draftline::apply_shelf,
            commands::draftline::delete_shelf,
            commands::draftline::selected_save,
            commands::draftline::selected_shelve,
            commands::draftline::selected_discard,
            commands::draftline::list_remotes,
            commands::draftline::list_remote_variations,
            commands::draftline::remote_variation_diagnostics,
            commands::draftline::adopt_remote_variation,
            commands::draftline::fetch_remote,
            commands::draftline::publish_current_variation,
            commands::draftline::preflight_apply_incoming,
            commands::draftline::apply_incoming,
            commands::draftline::preflight_merge_incoming,
            ...
            commands::recording::delete_orphaned_narration_assets,
            ...
            commands::narration_preview::synthesize_narration_voice_preview,
            ...
            commands::github::github_device_code_start,
