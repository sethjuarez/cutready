      ...
      return [
        {
          ...
          initial_goal: "Use the project tools to list the current project files, then summarize the first sketch title in one sentence.",
        ...
        },
        {
          ...
          initial_goal: "Draft narration for the setup walkthrough and verify the linked references.",
