...
export function IdentityDialog() {
  ...
  return (
    <Dialog isOpen={identityPromptOpen} onClose={handleClose} align="top" topOffset="20vh" width="w-full max-w-md mx-4" backdropClass="bg-[rgb(var(--color-overlay-scrim)/0.4)]">
